# Landing Page Capability - Limit Content Display

This capability defines the landing page functionality that displays available content items for selection, with the requirement to show only the first line (title) of content.

## Purpose

The landing page provides a clean, minimal interface for users to browse and select from all available bilingual content items before viewing them in the content viewer. The landing page should display only the first line (title) of content as a preview, while the content viewer displays the full content.
